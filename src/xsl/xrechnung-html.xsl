            ...
            <div id="uebersichtRechnungsuebersicht" class="box">
                ...
                <div class="boxtabelle boxinhalt" role="table">
                    ...
                    <div class="rechnungsZeile" role="row">
                        ...
                        <div id="BT-108" data-title="BT-108" class="boxdaten rechnungSp3 paddingBottom line1Bottom"
                             role="cell">
                            <xsl:value-of
                    ...
                    <div class="rechnungsZeile" role="row">
                        ...
                        <div id="BT-111" data-title="BT-111" class="boxdaten rechnungSp3 paddingBottom line1Bottom"
                             role="cell">
                            <xsl:value-of
                    ...
                    <div class="rechnungsZeile" role="row">
                        ...
                        <div id="BT-114" data-title="BT-114" class="boxdaten rechnungSp3 paddingBottom line2Bottom"
                             role="cell">
                            <xsl:value-of
    ...
    <xsl:template name="uebersichtUmsatzsteuer" match="xr:VAT_BREAKDOWN">
        <div class="boxzeile">
            <div class="uebersichtUmsatzsteuer box">
                ...
                <div class="boxtabelle boxinhalt" role="table">
                    <div class="rechnungsZeile" role="row">
                        <div class="boxdaten rechnungSp1 bold" role="rowheader">Umsatzsteuerkategorie:
    ...
    <xsl:template name="uebersichtNachlass" match="xr:DOCUMENT_LEVEL_ALLOWANCES">
        <div class="boxzeile">
            <div id="uebersichtNachlass" class="box">
                ...
                <div class="boxtabelle boxinhalt" role="table">
                    <div class="rechnungsZeile" role="row">
                        <div class="boxdaten rechnungSp1 bold" role="rowheader">Umsatzsteuerkategorie des Nachlasses:
    ...
    <xsl:template name="uebersichtZuschlaege" match="xr:DOCUMENT_LEVEL_CHARGES">
        <div class="boxzeile">
            <div id="uebersichtZuschlaege" class="box">
                ...
                <div class="boxtabelle boxinhalt" role="table">
                    <div class="rechnungsZeile" role="row">
                        <div class="boxdaten rechnungSp1 bold" role="rowheader">Umsatzsteuerkategorie des Zuschlages:
        ...
        <div class="boxtabelle boxabstandtop boxtabelleZweispaltig first">
            <div class="boxzeile">
                <div class="box subBox">
                    <div id="BT-126" data-title="BT-126" class="boxtitel" role="heading" aria-level="2">Position
            ...
            <div class="boxzeile">
                <div class="box subBox">
                    ...
                    <xsl:for-each select="xr:INVOICE_LINE_ALLOWANCES">
                        ...
                        <div class="grundDetail" role="list">
                            <div class="color2" role="listitem">Grund des Nachlasses:
                                <span id="BT-139" data-title="BT-139" class="bold">
                                    <xsl:value-of select="xr:Invoice_line_allowance_reason"/>
                                </span>
                            </div>
                            <div class="color2" role="listitem">Code für den Nachlassgrund:
                ...
                <div class="box subBox">
                    ...
                    <xsl:for-each select="xr:INVOICE_LINE_CHARGES">
                        ...
                        <div class="grundDetail" role="list">
                            <div class="color2" role="listitem">Grund des Zuschlags:
                                <span id="BT-144" data-title="BT-144" class="bold">
                                    <xsl:value-of select="xr:Invoice_line_charge_reason"/>
                                </span>
                            </div>
                            <div class="color2" role="listitem">Code für den Zuschlagsgrund:
                            ...
                            <div class="boxcell boxZweispaltig">
                                <div class="boxtabelle borderSpacing" role="list">
                                    ...
                                    <div class="boxzeile" role="listitem">
                                        ...
                                        <div id="BT-158-scheme-version-id" data-title="BT-158-scheme-version-id"
                                             class="boxdaten wert">
                                            <xsl:value-of
        ...
        <div class="boxtabelle boxinhalt borderSpacing" role="list">
            ...
            <div class="boxzeile" role="listitem">
                ...
                <div id="{xr:Supporting_document_reference}"
                     data-mimetype="{xr:Attached_document/@mime_code}"
                     data-filename="{xr:Attached_document/@filename}"
                     style="display:none;"
                >
